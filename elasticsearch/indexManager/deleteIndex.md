## 删除一个索引[编辑](https://github.com/elasticsearch-cn/elasticsearch-definitive-guide/edit/cn/070_Index_Mgmt/05_Create_Delete.asciidoc)
...
![注意](https://www.elastic.co/guide/cn/elasticsearch/guide/current/images/icons/note.png)
